...
def save_best_model(model, pre_processor_variant):
    model_dir = get_models_dir() / "LSTM_STFT_Dense_search" / "best_LSTM_STFT_Dense_models"
...
if __name__ == "__main__":
    LSTM_search_folder_path = str(get_models_dir()) + "/LSTM_STFT_Dense_search"
