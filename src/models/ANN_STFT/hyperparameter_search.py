...
class ANN_STFTHyperModel(kt.HyperModel):
...
if __name__ == "__main__":
    ...
    for pre_processor_variant in pre_processor_variants:
        ...
        hypermodel = ANN_STFTHyperModel(input_shape, num_classes)
        model_dir = get_models_dir() / "ANN_STFT_search"  # Changed directory name
        ...
        tuner.search(
            ...
            epochs=30,
            callbacks=[stop_early],  # Uncommented the early stopping callback
            verbose=2
        )
